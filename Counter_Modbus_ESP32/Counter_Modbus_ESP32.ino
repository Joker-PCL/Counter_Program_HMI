...
const int ON_ADDRESS[DEVICE_CNT] = { 610, 611, 612, 613, 614, 619, 616, 618 };       // กำหนด address on/off counter
...
void setup() {
  ...
  xTaskCreatePinnedToCore(counterLoop, "Task1", 10000, NULL, 9, &Task1, 1);
}
